...
(function (exports) {
    ...
    function * getRecentGames() {
        var recentGames = [
            ...
            {"winner": "Bret", "winnerScore": "11",  "loser": "Amber", "loserScore": "6", "time": "2014-08-29 18:35:22"},
            {"winner": "Amber", "winnerScore": "11",  "loser": "Jarrod", "loserScore": "7", "time": "2014-08-28 15:23:15"},
            {"winner": "Jarrod", "winnerScore": "11",  "loser": "Kevin", "loserScore": "4", "time": "2014-08-29 18:35:22"},
            {"winner": "Kevin", "winnerScore": "11",  "loser": "Amber", "loserScore": "5", "time": "2014-08-28 15:23:15"}
        ];
        ...
        yield Sql.using(
            function * (db) {
                ...
                for(var i = 0; i < allGames.rowCount; i+=2) {
                    ...
                    var p1 = allPlayers[gp1.player_id];
                    var p2 = allPlayers[gp2.player_id];
