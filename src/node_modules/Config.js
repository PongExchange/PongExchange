...
function getDefaults ()
{
	...
	{ 
		var url = (Config.web.ssl ? 'https://' : 'http://') + Config.web.host;
	...
	Config.web.static = {
		cssPath: '/static/css', // third party css
		lessPath: '/static/less',
		compiledLessPath: '/static/css-less',
		jsPath: '/static/js',
	...
	// --- Sessions ---
	Config.sessions = {};
	Config.sessions.signingKeys = process.env.SIGNING_KEYS || ["it's a secret to everybody"];
	Config.sessions.length = 30 * (1000 * 60 * 60 * 24); // 30 days
	Config.sessions.name = 'pong-session';
	...
	Config.google.scopes = [ 'profile', 'email' ];
