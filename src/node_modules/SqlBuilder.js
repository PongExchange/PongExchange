...
function resolveSql(t)
{
	...
	// replace any @param with $ordinal
	Object
		.keys(clauseParams)
		.filter(function(key) { return clauseParams[key] != null; })
		.forEach(function(key, i)
	{
		var paramName = '@' + key;
		if (t.resolvedSql.indexOf(paramName) >= 0)
		{
			t.resolvedSql = t.resolvedSql.replace(new RegExp(paramName, 'ig'), '$' + (i + 1));
			t.resolvedParams.push(clauseParams[key]);
		}
	});
