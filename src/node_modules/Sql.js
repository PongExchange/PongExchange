...
{
	var connString = Config.sql.connectionString;
	if (Sql.testingMode)
	{
		if (!Config.sql.testingConnection)
			throw new Error('You are running in testing mode, but no Config.sql.testingConnection was not set.');
		
		connString = Config.sql.testingConnection
	}
