...
function* insertGame(game)
{
	yield Sql.using(function*(db)
	{
		...
		var dbResult = yield db.query(
			"insert into games (played_date, game_type_id) values ($1, $2) returning id;",
			[game.played_date, game.game_type_id]);
...
{
	var teamIds = game['team' + teamNumber],
	...
	for (var i = 0; i < teamIds.length; i++)
	{
		yield db.query(
			...
			'values ($1, $2, $3, $4);', [game.id, teamIds[i].id, isWinner, teamScore]);
	}
}
