...
/**
 * Checks for duplicate affiliations
 * @returns true if name exists already
 */
 Affiliation.checkDup = function*(name)
 {
 	var affiliations = yield Affiliation.getAll();

	 for (var i = 0; i < affiliations.length; i++)
	 {
		 console.log(name, affiliations[i].name);
		 if (name.toLowerCase() === affiliations[i].name.toLowerCase())
		 {
			 return true;
		 }
	 } 
