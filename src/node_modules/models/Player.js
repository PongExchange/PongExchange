...
function Player (databaseRow)
{
	...
	this.player_type_id = row.player_type_id;
	this.created_date = row.player_created_date || row.created_date;
...
Player.prototype.save = function * ()
{
	...
	return yield this.id ? updatePlayer(this) : insertPlayer(this);
};
