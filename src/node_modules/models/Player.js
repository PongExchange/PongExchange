...
var DEFAULT_ROW = 
{
	...
	image_url: null,
	bio: null,
	role_id: Player.roles.pendingApproval
};
...
Player.prototype.save = function * ()
{
	...
	{
		var sql, res;
		var params = [ this.name, this.email, this.rating, this.googleId, this.googleProfile, this.imageUrl, this.bio, this.role_id ];
		if (!this.id)
		{
			// insert
			sql = 'insert into players (name, email, rating, google_id, google_profile, image_url, bio, role_id) values ($1, $2, $3, $4, $5, $6, $7, $8) returning id;';
		...
		// update
		sql = 'update players set name=$1, email=$2, rating=$3, google_id=$4, google_profile=$5, image_url=$6, bio=$7, role_id=$8 where id = $9';
		params.push(this.id);
		res = yield db.query(sql, params);
