...
Player.prototype.save = function * ()
{
	...
	{
		var sql, res;
		var params = [ this.name, this.email, this.rating, this.googleId, this.googleProfile, this.imageUrl, this.bio ];
		if (!this.id)
		{
			// insert
			sql = 'insert into players (name, email, rating, google_id, google_profile, image_url, bio) values ($1, $2, $3, $4, $5, $6, $7) returning id;';
		...
		// update
		sql = 'update players set name=$1, email=$2, rating=$3, google_id=$4, google_profile=$5, image_url=$6, bio=$7 where id = $8';
		params.push(this.id);
		res = yield db.query(sql, params);
